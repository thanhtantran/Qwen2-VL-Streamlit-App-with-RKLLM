...
void exit_handler(int signal)
{
    ...
    {
        {
            cout << "The program is about to exit" << endl;
...
int main(int argc, char** argv)
{
    ...
    //Set llm parameters and initialize
    ...
    pre_input.push_back("<image>Trong bức ảnh có gì？");
    cout << "\n**********************You can enter the following question numbers to get answers/or customize your input********************\n"
         << endl;
