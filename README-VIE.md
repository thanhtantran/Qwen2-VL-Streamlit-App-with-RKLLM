[en View in English](README.md)

# Ứng dụng Web Streamlit Qwen2-VL với RKLLM

Ứng dụng web Streamlit này cung cấp giao diện thân thiện để chạy suy luận mô hình Qwen2-VL bằng môi trường thực thi RKLLM.
...
Để thêm phiên bản mô hình mới:

1. Tạo thư mục mới trong thư mục `models/`
2. Đặt tệp `.rknn` và `.rkllm` tương ứng vào thư mục
3. Ứng dụng sẽ tự động phát hiện và hiển thị mô hình mới
...
Ứng dụng sẽ tự động xử lý ảnh và quản lý tệp tạm thời.

## Giấy phép

Dự án này tuân theo giấy phép giống với dự án chính Qwen2-VL RKLLM.
